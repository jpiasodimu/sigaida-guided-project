...
sigaida-guided-project/
 gen-ed-ai/ 
    api/ --> fetch_courses.py (ingestion), app.py (Flask)
...
4. Add your three API keys and Supabase URL to your .env file (in the `gen-ed-ai` folder): `ANTHROPIC_KEY` (from Claude API), `SUPABASE_URL`, `SUPABASE_ANON_KEY`, and `SUPABASE_SERVICE_KEY`
...
1. Ensure you are in the `gen-ed-ai` folder 
2. Run Next.js: `cd app`, open a new terminal and enter: `npm run dev` 
3. Run Flask: In another terminal, enter: `flask --app app run`
